...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal" action="admin/{{$url_table}}/add" method="post" enctype="multipart/form-data" >
				...
				<div class="form-group">
					<label class="col-sm-1 control-label no-padding-right"  for="form-field-1">Loại Tin</label>
 ...
 name="name" class="col-xs-10 col-sm-5"> -->
						...
						<?php foreach ($type_of_news as $key => $value): ?>
				...
				<div class="form-group">
					<label class="col-sm-1 control-label no-padding-right"  for="form-field-1">Tóm tắt</label>

					<div class="col-sm-9">
						<textarea name="brief" id="" cols="30" rows="10"></textarea>
					</div>
				</div>
				<div class="form-group">
