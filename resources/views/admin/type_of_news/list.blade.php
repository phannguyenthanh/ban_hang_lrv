	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="row">
					<div class="col-xs-12">
						<h3 class="header smaller lighter blue">Quản lí loại tin tức</h3>
								...
								<tr role="row" class="odd">
									...
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											...
											<a class="green" href="admin/type_of_news/edit/{{$value->id}}">
												<i class="ace-icon fa fa-pencil bigger-130"></i>
											</a>

											<a class="red" href="admin/type_of_news/remove/{{$value->id}}">
